...
<div class="bg">
	<div class="container-fluid bg">
		<div class="row">
			<springform:form action="televisionprocess" method="POST" modelAttribute="television">
				
				<div class="form-group">
				<springform:label path="screenSize">Screen Size:</springform:label>
				<springform:input path="screenSize"/>
				</div>
				
				<div class="form-group">
				<springform:label path="screenType">screen Type:</springform:label>
				<springform:input path="screenType"/>
				</div>
