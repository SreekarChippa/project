...
<nav class="navbar navbar-expand-md bg-dark navbar-dark">
            ...
            <div class="collapse navbar-collapse  justify-content-end" id="collapsibleNavbar">
              <ul class="navbar-nav">
                ...
                <li class="nav-item">
                  <a class="nav-link text-white" href="${contextPath}/customer/cart">Cart</a>
                </li>
                
                <li class="nav-item">
                  <a class="nav-link text-white" href="${contextPath}/customer/logout">Logout</a>
                </li>
   ...
   <ul class="navbar-nav">
    ...
    <li class="nav-item dropdown">
      ...
      <c:forEach  items="${electronics}" var="electronic">
					<a class="dropdown-item" href="${contextPath}/customerproducts/${electronic.subCategoryId}">${electronic.subCategoryName}</a> 
	  </c:forEach>
